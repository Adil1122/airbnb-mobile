...
class _CreateExperienceScreenState extends State<CreateExperienceScreen> {
  ...
  final List<Map<String, dynamic>> _categories = [
    ...
    {'label': 'Food & Drink', 'icon': Icons.restaurant_outlined},
    {'label': 'Art & Culture', 'icon': Icons.palette_outlined},
    {'label': 'Sports', 'icon': Icons.sports_outlined},
    {'label': 'Entertainment', 'icon': Icons.theater_comedy_outlined},
  ...
  Future<void> _publish() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Experience published successfully!'),
  ...
  Widget _buildStep1() {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          const Text('What kind of experience\nwill you host?',
              style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, height: 1.2)),
          const SizedBox(height: 8),
          const Text('Choose the category that best fits your experience.',
          ...
          TextField(
            ...
            decoration: InputDecoration(
              hintText: 'e.g. Sunset kayaking in Islamabad',
      ...
      child: Column(
        ...
        children: [
          ...
          TextField(
            ...
            maxLength: 500,
            textCapitalization: TextCapitalization.sentences,
            decoration: _inputDecoration('Describe your experience, what guests will do, and what makes it special.'),
          ),
          ...
          _buildGuestRow('Children', _maxChildren,
              onDec: () { if (_maxChildren > 0) setState(() => _maxChildren--); },
              onInc: () { if (_maxChildren < 50) setState(() => _maxChildren++); }),
          const SizedBox(height: 24),
          _buildLabel('Price per guest (USD)'),
          const SizedBox(height: 10),
          TextField(
      ...
      child: Column(
        ...
        children: [
          const Text('Add a photo &\nset availability',
              style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, height: 1.2)),
          const SizedBox(height: 8),
          const Text('A great cover photo helps your experience stand out.',
              style: TextStyle(fontSize: 15, color: Colors.black54)),
          const SizedBox(height: 32),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _summaryRow('Max guests', '${_maxAdults + _maxChildren} (${_maxAdults}A + ${_maxChildren}C)'),
          _summaryRow('Price', _priceCtrl.text.isEmpty ? '—' : '\$${_priceCtrl.text}/guest'),
        ],
      ),
    );
  }
            ...
            Expanded(
              ...
              child: ElevatedButton(
                ...
                child: _isLoading
                    ...
                    : Text(_currentStep < 2 ? 'Next' : 'Publish experience',
